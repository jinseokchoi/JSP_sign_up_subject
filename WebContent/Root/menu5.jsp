...
<%
 ...
 %>
<body>
<form name="myform" action="menu5_deletePro.jsp" method="post">
		<h1 align="center">
			학생 정보 삭제
			<hr>
		</h1>
		<table align="center" width="60%" border="1" cellspacing="0">
			<tr>
				<td align="center" height="40" colspan="7">학번 : <input
					type="text" name="student_id" size="10" maxlength="9"> <input
