...
url = "menu2_confirm.jsp?course_id=" + userinput.course_id.value ;
...
<form method="post" action="menu2_deletePro.jsp" name="userinput" onSubmit="return checkIt()">
...
<input type="button" name=menu2_confirm.jsp value="과목확인" OnClick="openConfirmid(this.form)">
</td>
</tr>
<tr>
<tr>
			<td colspan="2" height="40" align="center"">
			<input type="submit"name="confirm" value="개설 취소"> 
			<input type="reset"name="reset" value="다시입력"> 
			<input type="button" value="나가기" onclick="javascript:window.location='../Board/BoardMain.jsp'"></td>
		</tr>
</table>
<table align="center" width="600" border="1" cellspacing="0" cellpadding="3">
<tr bgcolor="#DCDCDC">
