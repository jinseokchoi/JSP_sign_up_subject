...
<ul id="navi"><br>
        <li class="group">
            <div class="title">학부수업</div>
            <ul class="sub">
                <li><a target="detail" href="menu1.jsp">- 수강신청</a></li>
        ...
        <li class="group">
            ...
            <ul class="sub">
                <li><a target="detail" href="menu4.jsp">- 정보확인</a></li>   
                <li><a target="detail" href="menu5.jsp">- 정보수정</a></li>               
            </ul>
        </li>
         </li>
        <li class="group">
